...
- [x] 回溯
  ...
  - [79.单词搜索](#79单词搜索)--二维矩阵的深搜
  - [130.被围绕的区域](#130被围绕的区域)--反向标记
  - [200.岛屿数量](#200岛屿数量)--标记, 深搜, 广搜
...
### 约瑟夫环
模拟法或者公式法。类似的题目有，猴子报数，报到几的出去，最后一个猴子为猴王。孩子玩游戏等
[YueSeFu](src/_00_YueSeFu.java)
...
用一个栈模拟这个过程，每次匹配到popped就弹栈，直到栈中元素是否为空
[ValidateStackSequences](src/_946_ValidateStackSequences.java)
...
反过来标记，也是深搜，遍历边界上的点，如果是0，则标记为'#'，然后已知深搜，直到标记完所有与边界相连的'0'
[Solve](src/_130_Solve.java)
